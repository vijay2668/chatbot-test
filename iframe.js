const ui = `<div
class="chatui hidden absolute bottom-4 right-4 w-full h-[80vh] rounded-xl sm:max-w-[400px] z-[99999]"
>
<div
  class="max-w-full w-full bg-transparent justify-end h-full items-end flex flex-col space-y-4 right-0"
>
  <div
    class="h-full bg-white flex flex-col rounded-2xl overflow-hidden w-full"
  >
    <div
      class="accent-color-elem relative rounded-t-2xl flex items-center justify-start w-full h-fit p-4 py-6"
    >
    <button 
    id="toggleButtonClose"
      class="inline-flex z-[99999999] items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 rounded-full absolute top-2 text-white right-2 h-fit"
      style="background: transparent"
    >
    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-x p-1"><path d="M18 6 6 18"></path><path d="m6 6 12 12"></path></svg>
</button>
      <div class="flex items-center justify-center space-x-3">
        ...
        <div class="flex flex-col">
          <label id="company-name"
            class="peer-disabled:cursor-not-allowed peer-disabled:opacity-70 font-semibold text-white text-lg leading-5 capitalize"
            ></label
          ><label id="company-subheading"
            class="font-medium peer-disabled:cursor-not-allowed peer-disabled:opacity-70 capitalize text-white/80 text-xs leading-5"
            ></label
          >
        </div>
      </div>
    ...
    <div class="flex flex-col overflow-hidden w-full h-full">
      ...
      >
        <div id="messages-list"
          class="w-full h-full flex flex-col overflow-y-scroll scrollbar-hide"
        >
      ...
      <form class="flex items-center">
        <input
          class="flex w-full rounded-md border-input bg-background px-3 py-2 ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-ring disabled:cursor-not-allowed disabled:opacity-50 h-10 text-base focus-visible:ring-0 focus-visible:ring-offset-0 border-0"
          id="userInput"
          value=""
          name="userInput"
        /><button
          type="submit"
          id="send"
          class="text-gray-400 relative h-full min-w-[30px] flex items-center justify-start"
        >
          <svg
            viewBox="0 0 20 20"
            id="accent-color-elem2"
...
<button
id="toggleButtonOpen"
class="accent-color-elem inline-flex z-[99999999] items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 rounded-full absolute bottom-4 right-4 p-2 h-fit"
>
